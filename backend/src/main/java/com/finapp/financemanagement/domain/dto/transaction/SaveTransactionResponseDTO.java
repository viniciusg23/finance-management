...
/**
 * Data Transfer Object (DTO) representing the response for saving a transaction.
 * This DTO contains information about the saved transaction including its ID, associated user ID,
...
public record SaveTransactionResponseDTO(
    ...
    /**
     * Constructs a SaveTransactionResponseDTO object based on the provided Transaction entity.
     *
     * @param transaction the Transaction entity to map to the DTO
     */
    public SaveTransactionResponseDTO(Transaction transaction){
        this(
            transaction.getId(),
